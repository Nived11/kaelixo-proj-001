...
export default function TrustedBySection() {
  const logos = [
    {
      ...
      render: () => (
        <div className="flex items-center gap-2.5">
          <svg className="w-[19px] h-[19px]" viewBox="0 0 21 21" fill="none">
          ...
          <span className="text-[20px] font-semibold tracking-tight">Microsoft</span>
        </div>
      ),
    },
    {
      ...
      render: () => (
        <div className="flex items-center">
          <span className="text-[23px] font-bold tracking-tight font-sans">
            Google
          </span>
        </div>
      ),
    },
    {
      ...
      render: () => (
        <div className="flex flex-col items-center justify-center pt-1">
          <span className="text-[23px] font-black lowercase tracking-tight leading-none">
            aws
          </span>
          {/* AWS Smile Arrow */}
          <svg className="w-10 h-2.5 mt-0.5" viewBox="0 0 50 14" fill="none">
            <path
    ...
    },
    {
      ...
      render: () => (
        <div className="flex items-center gap-2">
          <svg className="w-6 h-5 fill-current" viewBox="0 0 36 24">
          ...
          <span className="text-[20px] font-bold tracking-tight">Meta</span>
        </div>
      ),
    },
    {
      ...
      render: () => (
        <div className="flex items-center">
          <svg className="h-[22px] w-auto fill-current" viewBox="0 0 72 28">
    ...
    },
    {
      ...
      render: () => (
        <div className="flex items-center gap-2">
          ...
          <span className="text-[20px] font-bold tracking-tight">Adobe</span>
        </div>
      ),
    },
    {
      ...
      render: () => (
        <div className="flex items-center gap-2">
          ...
          <span className="text-[20px] font-bold italic tracking-tight font-sans">
            shopify
          </span>
        </div>
      ),
  ...
  return (
    <section className="relative bg-[#020205] py-14 overflow-hidden select-none border-t border-white/[0.04]">
      {/* Section Subtitle */}
      <div className="max-w-[1400px] mx-auto px-6 mb-9 text-center">
        <p className="text-[11px] sm:text-xs font-bold tracking-[0.28em] text-white/50 uppercase font-sans">
      ...
      >
        ...
        <div 
          className="animate-marquee-infinite flex w-max items-center transition-all duration-300"
          style={{
