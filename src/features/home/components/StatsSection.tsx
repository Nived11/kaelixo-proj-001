  ...
  const stats = [
    {
      ...
      icon: (
        <svg className="w-6 h-6 text-[#C084FC] fill-current [@media(min-width:1920px)]:w-8 [@media(min-width:1920px)]:h-8" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6 text-[#C084FC] fill-none stroke-current stroke-[1.8] [@media(min-width:1920px)]:w-8 [@media(min-width:1920px)]:h-8" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
